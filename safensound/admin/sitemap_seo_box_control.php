...
*/
  ...
  AddMissingBoxes(DIR_FS_CATALOG.DIR_WS_BOXES, $languages, $excludeList, $linkArray); //fill in the database with all boxes if not present
  $boxFilesGroup = GetBoxListGroup(DIR_FS_CATALOG.DIR_WS_BOXES, $languages, $excludeList);
  $boxFiles = GetBoxList(DIR_FS_CATALOG.DIR_WS_BOXES, $excludeList);
    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
     ...
     <tr>
      <td><table border="0" width="100%" style="background-color: #fff; border: ridge #CCFFCC 3px;">
         ...
         <tr>
          <th class="main" style="font-size: 14px"><?php echo HEADING_TITLE_BOXES_GROUP; ?></th>
         </tr>			
         <tr><td height="6"></td></tr>	        
         <tr>
          <td class="main"><?php echo TEXT_TITLE_BOXES_GROUP; ?></td>
         </tr>		 
         <tr><td height="6"></td></tr>	         
        </table></td>
       </tr> 
     ...
     <tr>
      <td><table border="0" width="100%" style="background-color: #fff; border: ridge #CCFFCC 3px;">
			 <tr>
			  <td><table border="0" width="100%" cellspacing="0" cellpadding="2" style="background-color: #f0f1f1; border: ridge #CCFFCC 3px;">
         <tr>
          <th class="main" style="font-size: 14px"><?php echo HEADING_TITLE_BOXES_INDIVIDUAL; ?></th>
         </tr>		
         <tr><td height="6"></td></tr>	
         <tr>
          <td class="main"><?php echo TEXT_TITLE_BOXES_INDIVIDUAL; ?></td>
         </tr>		 
         <tr><td height="6"></td></tr>	
        </table></td>
       </tr>       
              ...
              <?php
               ...
               {               
                  ...
                  { 
                     ...
                     echo '<td width="30%" style="background-color:' . $bkcolor . '">' .GetNameFromDefine($linkArray[$b]['text'], $languages[$i]['directory']) .'</td>';
     ...
     <tr>
      <td><table border="0" width="100%" style="background-color: #fff; border: ridge #CCFFCC 3px;">
			 <tr>
			  <td><table border="0" width="100%" cellspacing="0" cellpadding="2" style="background-color: #f0f1f1; border: ridge #CCFFCC 3px;">
         <tr>
          <th class="main" style="font-size: 14px"><?php echo HEADING_TITLE_ADDITIONAL_LINKS; ?></th>
         </tr>		
         <tr><td height="6"></td></tr>	
         <tr>
          <td class="main"><?php echo TEXT_TITLE_ADDITIONAL_LINKS; ?></td>
         </tr>		 
         <tr><td height="6"></td></tr>	
        </table></td>
       </tr>       
