...
$OutFile = DIR_FS_DOCUMENT_ROOT."feeds/data_feed.txt";
$destination_file = data_feed.txt;  //"CHANGEME-filename-to-upload-to-froogle.txt" ;
$source_file = $OutFile;
...
$ftp_user_name = davidwitney;

$ftp_user_pass = datafeeder1;
...
if($convertCur)
{
	$productURL = HTTP_SERVER . DIR_WS_CATALOG .'product_info.php?&products_id=';  // Product URL if Currency Conversion is enabled
}
...
$instock = 1;
$shipping = 1;
	$lowestShipping = "US:Ground:2.05,CA:Ground:2.05,UK:Ground:1.70,DE:Ground:0,AT:Ground:1.70,IE:Ground:1.70,CH:Ground:1.70,DK:Ground:1.70,PL:Ground:1.70,FR:Ground:1.70";  // Put your shipping costs details (up to 10 options), respecting the format.  See  http://base.google.com/base/attributes.html#shipping
$brand = 1;
...
$tax_percent = 15;  // Suggested to use this option only if *all* your products have the same tax rate
	$default_tax_percent = "15";  // Does not need to be an integer (e.g. "7.5") - do not put the "%" sign.
...
$location = 1;
	$default_location = "Unit 25 Croydon House 1 Peall Road, Croydon, Surrey, CR0 3EX, England";  // Addresses should be formatted as: street, city, state, postal code, country. Each location element should be separated by a comma.
