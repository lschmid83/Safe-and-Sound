...
$destination_file = FROOGLE_US_FTP_FILENAME;  //"CHANGEME-filename-to-upload-to-froogle.txt" ;
$source_file = $OutFile;
...
$GB_localization = "us";  // Do not modify! - unless Google Base opens up other localized versions, e.g. Australiia.
...
$instock = 1;
$shipping = 1;
	$lowestShipping = "US:Ground:3.95,CA:Ground:3.95,UK:Ground:3.30,DE:Ground:0,AT:Ground:3.30,IE:Ground:3.30,CH:Ground:3.30,DK:Ground:3.30,PL:Ground:3.30,FR:Ground:3.30";  // Put your shipping costs details (up to 10 options), respecting the format.  See  http://base.google.com/base/attributes.html#shipping
$brand = 1;
...
$tax_percent = 1;  // Suggested to use this option only if *all* your products have the same tax rate
	$default_tax_percent = "7";  // Does not need to be an integer (e.g. "7.5") - do not put the "%" sign.
$tax_region = 1;  // Suggested to use this option only if *all* your products have the same tax region
	$default_tax_region = "Florida";  // Change this according to your applicable tax region
$product_type = 1;
$product_model = 1;
$currency = 1;
	$default_currency = "USD";  // The currency of the prices of this feed.
