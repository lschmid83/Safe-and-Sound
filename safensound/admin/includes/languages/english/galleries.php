...
define('HEADING_TITLE', 'osCommerce Image Gallery v1.0<br><span class="smallText">Lawrence Schmid</span>');
define('HEADING_TITLE_SEARCH', 'Search:');
define('HEADING_TITLE_GOTO', 'Go To:');

define('TABLE_HEADING_ID', 'ID');
define('TABLE_HEADING_CATEGORIES_PRODUCTS', 'Gallery');
define('TABLE_HEADING_ACTION', 'Action');
define('TABLE_HEADING_STATUS', 'Status');

define('TEXT_NEW_PRODUCT', 'New Product in &quot;%s&quot;');
define('TEXT_CATEGORIES', 'Categories:');
define('TEXT_SUBCATEGORIES', 'Gallery Sub galleries:');
define('TEXT_PRODUCTS', 'Galleries:');
...
define('TEXT_PRODUCTS_SHORT_DESC', 'Short Description: ');
