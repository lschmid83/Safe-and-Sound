...
// smsupdates box text in includes/boxes/smsupdates.php
define('BOX_HEADING_SMSUPDATES','SMS Updates');
define('BOX_SMSUPDATES_DEFAULTS','Default messages');
define('BOX_SMSUPDATES_COUNTRIES','SMS Countries');

//visitor mail list
define('BOX_ENTRY_VISITOR_MAILS', 'E-mail List');
