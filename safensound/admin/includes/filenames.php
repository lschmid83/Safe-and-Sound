...
// define the filenames used in the project
  ...
  define('FILENAME_GALLERIES', 'galleries.php');
  ...
  define('FILENAME_SMSDEFAULTS','smsdefaults.php');
  define('FILENAME_SMSCOUNTRIES','smscountries.php');
  define('FILENAME_VISITOR_MAIL_LIST', 'visitor_mail_list.php');
 /***** Begin Sitemap_SEO *****/
