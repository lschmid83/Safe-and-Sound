...
<?php
  ...
  if ($selected_box == 'tools') {
    $contents[] = array('text'  => '<a href="' . tep_href_link('asnf_admin.php') . '" class="menuBoxContentLink">' . Forum . '</a><br>' .
                                   ...
                                   '<a href="' . tep_href_link('mail_export.php', '', 'NONSSL') . '" class="menuBoxContentLink" target="_blank">Email Export</a><br>' .
                                   '<a href="' . tep_href_link('unregistered_mail_export.php', '', 'NONSSL') . '" class="menuBoxContentLink" target="_blank">Unregistered Email Export</a><br>' .
