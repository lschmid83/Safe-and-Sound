...
<body style="margin-bottom:5px;background-image: url(http://localhost:7080/safensound/catalog/images/bg.png);background-repeat: repeat-x; background-color: 215388;">
    <!-- header //-->
...
// Get the right image for the top-right
    ...
    if (isset($HTTP_GET_VARS['manufacturers_id'])) {
      ...
      $image = $image['categories_image'];
            ...
            ?>
            <td width="400px" valign="top" class="maincont_mid_td">
				...
				$URLofyoursite = "http://localhost:7080/safensound"; 						// Enter your sites URL.
				$AbsoluteServerPathofyoursite = "http://localhost:7080/safensound";		// Enter the root path of your site on the server.
    ...
    include(DIR_WS_MODULES . FILENAME_UPCOMING_PRODUCTS);
            ...
            <td width="<?php echo BOX_WIDTH; ?>" valign="top" class="maincont_right_td">
                <table border="0" width="<?php echo BOX_WIDTH; ?>" cellspacing="0" cellpadding="0" class="rightbar_tb">
                    <!-- right_navigation //-->
