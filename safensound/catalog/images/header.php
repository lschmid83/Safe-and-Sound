...
<?php require(DIR_WS_LANGUAGES . $language . '/menu.php'); ?>
<?php
...
<tr>
	...
	<tr>
		<td width="950" style="padding-top:5px">
		...
		<td width="950" class="topbanner_tb">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="menubarmain">
				<tr>
					...
					<td align="center" width="180"><a href="<?php echo tep_href_link(FILENAME_SPECIALS);?>">Gallery</a></td>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0"></td>
					<td align="center" width="180"><a href="<?php echo tep_href_link(FILENAME_ACCOUNT, '', 'SSL'); ?>">Login</a></td>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0"></td>
					<td align="center" width="180"><a href="<?php echo tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'); ?>">Checkout</a></td>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0"></td>
	...
	<tr>
		<td width="950"><a href="<?php echo tep_href_link(FILENAME_SPECIALS);?>"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_main_pic.jpg" border="0"></a></td>
	</tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"  class="az_info_bar">
	<tr>
	   <td width="9" valign="top"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_left.gif" border="0"></td>
	   <td width="290" valign="top" align="left" style="color:#FFF; padding-left:4px" class="az_info_bar_td2">
	  	   ...
	  	   <td width="10"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_div.gif" border="0"></td>
	  	   <td width="300" align="center" class="az_info_bar_td3">
	  	   ...
	  	   <td width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_right.gif" border="0"></td>
	  	</tr>
	  	</table>
