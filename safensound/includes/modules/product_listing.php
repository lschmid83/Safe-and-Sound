      ...
      for ($col=0, $n=sizeof($column_list); $col<$n; $col++) {
        ...
        switch ($column_list[$col]) {
          ...
          case 'PRODUCT_LIST_IMAGE':
            ...
            break;
          case 'PRODUCT_LIST_BUY_NOW':
            if($listing['manufacturers_id'] == 26 || $current_category_id == 60515)
            {
							$lc_align = 'center';
							$lc_text = 'Collection only';
							break;
            }
            else
            {
							...
							$lc_align = 'center';
							$lc_text = $listing['manufacturers_id'];
							$lc_text = '<a href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $listing['products_id']) . '">' . '<img src="catalog/images/buttons/add_to_basket.png" border="0">' . '</a>&nbsp;';
							break;
            }
        }
