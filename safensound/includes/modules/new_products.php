...
<?php
  ...
  while ($new_products = tep_db_fetch_array($new_products_query)) {
    ...
    $product_info_str =  '<table border="0" width="185" style="table-layout:fixed" cellspacing="0" cellpadding="0" class="hl_product_box" onmouseover="this.className=\'hl_product_box_over\'" onmouseout="this.className=\'hl_product_box\'"><tr><td valign="top">';
    ...
    $product_info_str .= '<table border="0" width="100%" cellspacing="0" cellpadding="0" class="productBox" ><tr><td align="left">';
    ...
    $product_info_str .= '</td></tr></table>';
    $product_info_str .= '<table border="0" width="100%" cellspacing="0" cellpadding="0" class="productBottomLine">';
    ...
    if ($col > 3) {
      ...
      $row ++;
			...
			$info_box_contents[$row][$col] = array('align' => 'center',
												 ...
												 'text' => '<img src="'. DIR_WS_TEMPLATE_IMAGES .'az_prod_vrt_line.gif" width="1px" alt="" >');
			$col ++;
	}
