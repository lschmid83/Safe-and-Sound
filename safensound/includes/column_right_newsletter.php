...
?>
	...
	<?php include(DIR_WS_BOXES . 'visitoremail.php'); ?>


	<tr>
	<td width="182px" align="center" style="padding-bottom:3px; table-layout:fixed"  ><a href="/contact_us.php"> <img border=0 src="/catalog/images/showroom.jpg" width="182px" alt=""></a></td>
	</tr>
