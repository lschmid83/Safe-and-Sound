...
echo '<img height="5" src="images/space.gif" width="100%"><br>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="5">
        <tr >
            ...
            <td width="20%" class="asnf_normal" colspan="4">
              <input type="text" name="asnfkeywords" size="50">

            </td>
            <td width="20%" class="asnf_normal" align="left" colspan="2" style="margin-top:5px">
                ...
                <tr>
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="3" bgcolor="#f5f5f5">
                      <tr>
                        <td class="asnf_normal" align="center"><b><a href="asnf_newtopic.php" class="asnf_none">
                        Search</a></b></td>
                      </tr>
                    </table>
                  </td>
        ...
        <tr>
            <td width="20%" class="asnf_normal" align="left">' .
                 TEXT_ASN_FIND_IN_POST . ':
            </td>
            <td  class="asnf_normal" >
              <input type="checkbox" name="search_in_post" value="1" checked>
            </td>
            <td width="10%"  class="asnf_normal" align="left">' .
				TEXT_ASN_FIND_WHERE . ':
			</td>
			<td class="asnf_normal" align="left">' .
				listTopics('', TEXT_ASN_FIND_ALL) . '
            </td>
        </tr>
...
?>
  ...
  <table width="<?php echo $tablewidth; ?>" border="0" cellspacing="1" cellpadding="5" bgcolor="white">
    ...
    <tr>
    <td align="left"> <table border="0" cellspacing="0" cellpadding="1" bgcolor="#CCCCCC" width="125">
                <tr>
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="3" bgcolor="#f5f5f5">
                      <tr>
    ...
    <?php echo TEXT_ASN_TOPICS; ?>: <b><?php echo $total_topic; ?></b> | <?php echo TEXT_ASN_POSTS; ?>: <b><?php echo $total_post; ?></b></td>
