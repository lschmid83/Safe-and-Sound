...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_IPN_TEXT_SELECTION', '<img src="http://www.safensound.co.uk/catalog/images/icons/paypal.gif" align="left"  width="73px" height="25px"  style="margin-right:7px;vertical-align:middle"">Credit/Debit Card or eCheck (via PayPal)');
