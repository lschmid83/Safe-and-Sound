...
define('PREVNEXT_TITLE_PAGE', 'Select Page');
...
define('ENTRY_STREET_ADDRESS', 'Adress Line 1:');
define('ENTRY_STREET_ADDRESS_ERROR', 'Your Street Address must contain a minimum of ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' characters.');
define('ENTRY_STREET_ADDRESS_TEXT', '*');
define('ENTRY_SUBURB', 'Adress Line 2:');
...
define('ENTRY_SMS_NUMBER', 'SMS number:');
define('ENTRY_SMS_NUMBER_ERROR', '');
define('ENTRY_SMS_NUMBER_TEXT', 'Optional free order updates by SMS. Please specify using the international format (eg +44 78987 123 456');

// Simple Visitor Newsletter v1.00
define('BOX_HEADING_VISITOR_EMAIL', 'Subscribe for our Newsletter');

/***** Begin Sitemap_SEO *****/
define('BOX_INFORMATION_SITEMAP_SEO', 'Sitemap');
/***** End Sitemap_SEO *****/

// Holiday settings Begin
define('TABLE_HEADING_HOLIDAY', 'Please Note');
define('TABLE_MESSAGE', 'The owners will not be available from 26/03/12 until 11/04/12. Anything ordered will not be sent until the owners return.');
define('TABLE_MESSAGE_CONTACT', 'We are away at present from 26/03/12 until 11/04/12. We will reply to your enquiry as soon as possible.');
// Holiday settings End

//SEO Meta Tags
define('META_TITLE', 'Safe\'n\'Sound - Car audio including stereos, speakers, subwoofers, amplifiers and navigation');
define('META_DESCRIPTION', 'Car audio & security at great prices, including car stereo, Dension in car i-pod iphone adaptors, car subwoofers, car amplifiers & in-car navigation. Brands include Alpine, Dice, Kenwood, JL Audio, JVC, Pioneer, Sony and many more....');
define('META_KEYWORDS', 'alpine,car audio,car radio,car stereo,car amps,car recievers,headunits,car speakers,bluetooth,changers,dvd players,car speaker,subs,stereo,amplifiers,subwoofer,ipod,monitors,london,croydon');
