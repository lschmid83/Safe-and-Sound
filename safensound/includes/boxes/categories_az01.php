<?php
/*
  $Id: categories.php,v 2.00 2004/03/07 hpdl Exp $

  For osCommerce, Open Source E-Commerce Solutions

  http://www.template-faq.com

  Copyright (c) 2004 template-faq.com

*/

$side = $column_location .'_categ';
$css_ext = $column_location.'_az01';
$nr = 1;
...
// end background variables
    ...
    $categories_string .= '<TR><TD class="infoBoxContents' . $side . '" >&nbsp&nbsp&nbsp';
...
$info_box_contents[] = array('align' => 'left',
                               'text'  => '<TABLE BORDER="0" WIDTH="100%" CELLSPACING="0" CELLPADDING="0">'.$categories_string.'</TABLE>'
                              );

  new infoBox($info_box_contents, $css_ext, '0', '0');
