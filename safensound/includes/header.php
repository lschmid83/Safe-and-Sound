...
<?php
	...
	function az_tep_image_submit($image, $alt = '', $parameters = '') {
		...
		$button_html = '<IMG border="0" alt="" width="5px" height="17px" SRC="'. DIR_WS_TEMPLATE_IMAGES . 'az_button_left.gif">';
		$button_html .= '<input class="az_button_submit" '. $css_buttons_fix .' type="submit" value="'.$alt.'" ' . $parameters.  ' >';
		$button_html .= '<IMG border="0" alt="" width="19px" height="17px" SRC="'. DIR_WS_TEMPLATE_IMAGES . 'az_button_right.gif">';
		return $button_html;
	}
?>
...
<!-- top logo header -->
<table width="950px" border="0" cellpadding="0" cellspacing="0" align="center" style="background-color:#ffffff;table-layout:fixed" >
<tr>
	<td>
	<table width="950px" border="0" align="center" cellpadding="0" cellspacing="0" style="table-layout:fixed"  >
	<tr>
		<td style="padding-top:5px; table-layout:fixed" >
			<img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_top.jpg" width="950px" border="0" alt=""><br>
		</td>
	</tr>
	<tr>
		<td class="topbanner_tb" width="950px" style="table-layout:fixed">
			<table border="0" cellspacing="0" cellpadding="0" class="menubarmain">
				<tr>
					<td align="center" width="185"><a href="<?php echo tep_href_link(FILENAME_DEFAULT); ?>">Home</a></td>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0" alt=""></td>
					<td align="center" width="185"><a href="gallery.php">Gallery</a></td>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0" alt=""></td>
					<td align="center" width="185"><a href="http://safensounds.wordpress.com/">Blog</a></td>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0" alt=""></td>
					<?php
					...
					?>
					<td align="center" width="6"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_div.gif" border="0" alt=""></td>
					<td align="center" width="185"><a href="<?php echo tep_href_link(FILENAME_CONTACT_US); ?>">Contact Us</a></td>
				</tr>
			</table>
		</td>
	</tr>
	</table>
	<table border="0" align="center" cellpadding="0" cellspacing="0" width="950px" style="table-layout:fixed">
	<tr>
		<td><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_main_pic.jpg" border="0" alt=""></td>
	</tr>
	</table>
	<table width="950px" border="0" cellpadding="0" cellspacing="0" align="center"  class="az_info_bar" style="padding-bottom:1px;">
	<tr>
		<td width="9" valign="top"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_left.gif" border="0" alt=""></td>
	    	<td width="270" valign="top" align="left" style="color:#FFF; padding-left:4px; padding-top:5px" class="az_info_bar_td2"></td>
	    	<td valign="top" width="18" style="padding-top:4px;"><a href="blog" target="_blank"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>/icons/word press blog.jpg" alt="Safe'n'Sound Wordpress Blog" border="0"></a></td>
	    	<td valign="top" width="18" style="padding-top:4px; padding-right:8px"><a href="http://www.facebook.com/people/SafenSound-Croydon/100000444721116" target="_blank"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>/icons/facebook.jpg" border="0" alt="Safe'n'Sound Facebook"></a></td>
	    <td valign="top" width="10" ><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_div.gif" border="0" alt=""></td>
		   <td align="center" class="az_info_bar_td2">
	  	   ...
	  	   <td width="10" valign="top"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_div.gif" border="0" alt=""></td>
	  	   <td width="300" valign="top" align="center" class="az_info_bar_td3">
					<div id="btn_animBoxCart" class="jsTrigger">
						<table  style="padding-top:1px" width="200" border="0" cellspacing="0" cellpadding="0" align="right">
	  	   ...
	  	   <td width="6" style="padding-top:2px" valign="top"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>az_header_bar_right.gif" border="0" alt=""></td>
	  	</tr>
	  	</table>
