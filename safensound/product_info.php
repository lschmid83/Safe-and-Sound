...
<?php
    ...
    tep_db_query("update " . TABLE_PRODUCTS_DESCRIPTION . " set products_viewed = products_viewed+1 where products_id = '" . (int)$HTTP_GET_VARS['products_id'] . "' and language_id = '" . (int)$languages_id . "'");
     ...
     if (tep_not_null($product_info['products_model'])) {
       ...
       $products_manufacturer = $product_info['manufacturers_id'];
     } else {
...
?>
                ...
                <tr>
					...
					document.write('<?php echo '<a href="' . tep_href_link(DIR_WS_IMAGES . $product_info['products_image']) . '" target="_blank" rel="lightbox" title="'.$product_info['products_name'].'" >' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], 255, 204, 'hspace="5" vspace="5"') . '<br><br><img src="images/icons/magnify.png" width="16px" height="16px" style="vertical-align:middle" border="0"> ' . TEXT_CLICK_TO_ENLARGE . '</a>'; ?>');
					//--></script>
					<noscript>
                    ...
                    <?php
                        $ebay_url = tep_ebay_compare_url($product_info['products_id']);
						$amazon_url = tep_amazon_compare_url($product_info['products_id']);
                    ?>
	 					<td valign="top">
	 						<table border="0" cellspacing="0" cellpadding="0">
	 						<tr>
                                <td valign="top" width="195px" height="147px" style="background: url('images/product_info_bg.png'); background-repeat: no-repeat; background-position:0px 10px; ">
                                <table border="0" cellspacing="0" cellpadding="0">
	 							<tr>
	 							...
	 							<tr>
 							  <?php
 							  	$stock_url = 'http://www.safensound.co.uk/stock_check.php?url=' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];

 							  	if($product_info['products_quantity'] > 0)
 							  	{
 							  ?>
 							  		<td width="195px" style="color:#000000; padding-top:6px; padding-left:57px; font-size:14px">In Stock Now</td>
								<?php
									}
									else
									{
 							  ?>
 							 			<td width="195px" style="color:#000000; padding-top:6px; padding-left:52px; font-size:14px">Stock Check <a href=javascript:popUp(<?php echo "'" . $stock_url . "'"?>,'window','400','200')><img src="/images/icons/QuestionMark.gif" width="16" height="16" style="vertical-align:middle; margin-left:3px; margin-top: 1px; border:none"/></a></td>
								<?php
									}
								?>
	 							...
	 							<tr>
	 								<?php
										if($products_manufacturer == 26 || $current_category_id == 60515)
										{
											echo '<td width="195px" border="0" style="padding-top:6px; color: #000000; font-size:14px"><center>Collection Only</center></td>';
										}
										else
										{
									?>
	 						...
	 						<tr>
	 							<td>
	 								...
	 								<tr>
	 									...
	 									<td style="color:#000000; padding-top:11px; padding-left:5px; font-size:12px">1 Year Manufacturers Warranty</td>
	 								</tr>
	 								<tr>
	 									<td valign="center" style="color:#000000; padding-top:12px;"><img src="images/tick.png" style="padding-top:5px" width="16px" height="16px" border="0"/></td>
...
<?php
	...
	$full_product_desc = str_replace("Retetion", "Retention", $full_product_desc);	//dension fix
	$full_product_desc = str_replace("http://www.connects2.com", "http://www.connects2.co.uk", $full_product_desc); //connects2 fix
	$full_product_desc = str_replace('<p><b style="color:#FF0000">You will need to purchase a separate cradle or lead with this product which is available from our listings.</b> </p><br>', '<p><b style="color:#FF0000">You will need to purchase a separate cradle or lead with this product which is available from our <a href="http://www.safensound.co.uk/densionaccessories-c-60318_60543.html" style="color:#FF0000; font-weight:bold;"  onmouseover="this.style.textDecoration = \'underline\'" onmouseout="this.style.textDecoration = \'none\'">listings.</a></b> </p><br>', $full_product_desc);
	...
	//create info box
	if(strlen($product_description_string) > 110)
	{
		//create info box
