      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
          	<td class="main" align="center" valign="top" width="100px"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
            <td class="main" align="left" valign="top"><?php echo tep_address_label($customer_id, $billto, true, ' ', '<br>'); ?></td>
            <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
          </tr>
        </table></td>
      </tr>
...
?>
              <tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" width="80%" valign="top"><?php echo TEXT_SELECT_PAYMENT_METHOD; ?><br>Orders Processed by ePDQ can only be sent to the cardholders address.<br><br></td>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="mainred"><?php echo TABLE_MESSAGE;?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
