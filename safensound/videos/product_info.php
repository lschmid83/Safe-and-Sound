	 					...
	 					<td valign="top">
	 						...
	 						<tr>
 							  ...
 							  ?>
								...
								<?php
									...
									{
 							  ?>
 							 			<td width="195px" style="color:#000000; padding-top:6px; padding-left:49px; font-size:14px">Stock Check <a href=javascript:popUp(<?php echo "'" . $stock_url . "'"?>,'window','400','200')><img src="/images/icons/QuestionMark.gif" width="16" height="16" style="vertical-align:middle; margin-left:3px; margin-top: 1px; border:none"/></a></td>
								<?php
									}
								?>
	 						...
	 						<tr>
	 							<td>
	 								<table border="0" cellspacing="0" cellpadding="0">
	 								<tr>
	 									<td style="padding-top:12px; width:80px">
	 									<?php include (DIR_WS_MODULES . FILENAME_ADD_THIS); ?>
	 									</td>
	 								  <?php $stock_url = 'http://www.safensound.co.uk/stock_check.php?url=' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]; ?>
									  	<td style="padding-left:2px; padding-top:12px"><img src="images/money_pound.png" width="16px" height="16px" border="0"/></td>
									  	<td style="color:#000000; font-size:12px; padding-top:11px; padding-left:8px;">Price Match</td>
