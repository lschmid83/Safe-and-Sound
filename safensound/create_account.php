...
// PWA EOF
  if (isset($HTTP_GET_VARS['guest'])) tep_redirect(tep_href_link(FILENAME_SHOPPING_CART));
// PWA BOF
...
// needs to be included earlier to set the success message in the messageStack
  ...
  if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process')) {
    ...
    $smsnumber = tep_db_prepare_input($HTTP_POST_VARS['smsnumber']);
...
// PWA EOF
    ...
    if ($error == false) {
	   ...
	   $visitor_query = tep_db_query("select email from " . TABLE_VISITOR . " where email = '" . $email_address . "'");
	   if ($visitor = tep_db_fetch_array($visitor_query)) {
			tep_db_query("delete from " . TABLE_VISITOR . " where email = '" . $email_address . "'");
			$newsletter = 1;
	   }
...
<!-- body_text //-->
 <!-- PWA BOF -->
    ...
    <!-- PWA EOF -->
    <td width="580px;" valign="top" class="maincont_mid_td">
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('street_address') . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_TEXT) ? '<span class="inputRequirement">' . '*' . '</span>': ''); ?></td>
              </tr>
<?php
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('suburb') . '&nbsp;' . (tep_not_null(ENTRY_SUBURB_TEXT) ? '<span class="inputRequirement">' . 'Address Line 2'. '</span>': ''); ?></td>
              </tr>
<?php
  }
?>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('telephone') . '&nbsp;' . (tep_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span class="inputRequirement">' . 'Please specify for free order updates by SMS.' . '</span>': ''); ?></td>
              </tr>
             <tr>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo tep_draw_checkbox_field('newsletter', '1') . '&nbsp;' . '<span class="inputRequirement">' . 'We take your privacy seriously and will never give your details to third parties.' . '</span>' ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
